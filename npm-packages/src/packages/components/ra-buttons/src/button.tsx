 ...
 * @ Modified time: 2025-03-17 23:46:53
 * @ Description: This module provides the `Button` component, a customizable and reusable button element for React Native applications. It supports various types, sizes, colors, and states (e.g., loading, disabled).
 */
...
/**
 * @class Button
 * @classdesc The `Button` component is a flexible and customizable button element for React Native.
 *            It supports various visual styles, sizes, colors, and states, along with optional icons and loading indicators.
