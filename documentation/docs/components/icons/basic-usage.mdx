...
| color  | [`IconColor`](#iconcolor) | **false** | `theme.colors.text` | Icon color one of color used by [`BaseTheme<TColors>`](/docs/getting-started/setup-@flexnative/theme-provider#basethemetcolors) or given [`ColorValue`](https://reactnative.dev/docs/colors) by user. |
