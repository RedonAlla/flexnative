...
| color  | [`BaseColors`](../../theme/default-theme.mdx#basecolors) | **false** | `theme.colors.text` | Icon color one of color used by [`BaseTheme<TColors>`](../../theme/default-theme.mdx#basecolors) or given [`ColorValue`](https://reactnative.dev/docs/colors) by user. |
