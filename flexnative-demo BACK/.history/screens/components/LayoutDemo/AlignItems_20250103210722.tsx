  ...
  public render() {
    return (
      <DemoBlock title='Align Items'>
        ...
        <Block alignItems='center' style={blockStyle('#FF5733')}>
          <Text style={styles.text}>center</Text>
        </Block>

        <Block alignItems='space-around' style={blockStyle('#C70039')}>
          <Text style={styles.text}>space-around</Text>
          <Text style={styles.text}>space-around</Text>
        </Block>

        <Block alignItems='space-between' style={blockStyle('#9b59b6')}>
