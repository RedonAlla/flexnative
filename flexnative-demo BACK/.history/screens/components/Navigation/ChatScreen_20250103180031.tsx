  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={[styles.header, { backgroundColor: theme.colors.secondary }]}>
        <Button iconLeft='menu' radius='full' color='secondary' type='text' onPress={() => navigation.dispatch(DrawerActions.openDrawer())} /> <Text style={[styles.headerText]}>Chats</Text>
      </View>

      {/* Chat items */}
      {chatItems.map((item, index) => (
        <View key={index} style={styles.chatItem}>
          <Image source={require(`../../../assets/icons/${item.avatar}.jpg`)} style={styles.avatar} />
...
const chatItems = [
  {
    ...
    date: '03/12/2024',
    avatar: '../../../assets/icons/avatar-1.jpg',
  },
  {
    name: 'Eli',
    message: 'Tani e fika',
