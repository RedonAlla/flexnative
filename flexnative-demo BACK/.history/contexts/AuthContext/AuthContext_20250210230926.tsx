 ...
 * @ Modified time: 2025-02-10 23:09:26
 ...
 * 
 * @type {React.Context<AuthContextProps<any, any> | undefined>}
 */
const AuthContext: React.Context<AuthContextProps<any, any> | undefined> =
  React.createContext<AuthContextProps<any, any> | undefined>(undefined);
 ...
 *
 * @returns {AuthContextProps<TLoginRequest, TUser>} The current value of the `AuthContext`.
 */
export function useAuthContext<TLoginRequest, TUser>(): AuthContextProps<TLoginRequest, TUser> | undefined {
