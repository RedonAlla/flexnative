 ...
 * @ Modified time: 2025-02-11 23:00:17
 ...
 * @returns {Promise<string | null>} - A promise that resolves to the value of the item, or null if the item does not exist.
 */
 ...
 */
export function useAuthState(key: string, defaultValue: string | null): UseStateHook<string> {
    ...
    if (isWeb) {
      try {
        if (typeof localStorage !== 'undefined') {
          console.log('CACHE: ', localStorage.getItem(key))
