 ...
 * @ Modified time: 2025-02-27 22:07:18
 ...
 */
export const HeaderBackground: React.FC<HeaderBackgroundProps> = async ({ isDark, tint }) => {
  
  const tintStyle =  tint ?? await getTint().then((tint) => {
    console.log('tint 1:', tint);
    return tint;
  }).then((tint) => {
    console.log('tint 2: ', tint);
    return tint;
  }).then((tint) => {
    console.log('tint 3: ', tint);
    return tint;
  }).then((tint) => {
    console.log('tint 4: ', tint);
    return tint;
  });
  console.log('tintStyle: ', tintStyle);
