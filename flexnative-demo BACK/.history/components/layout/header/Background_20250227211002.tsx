 ...
 * @ Modified time: 2025-02-27 21:10:02
...
export const HeaderBackground: React.FC<HeaderBackgroundProps> = ({ isDark, tint }) => {
  ...
  const tintStyle =  tint ?? await import('@flexnative/theme-context').then((theme) => {
    console.log('theme', theme);
    return theme.scheme === 'dark' ? 'systemChromeMaterialDark' : 'systemThickMaterialLight';
  })
...
function getTint(tint: BlurTint): BlurTint {
