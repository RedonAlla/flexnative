...
const LoginScreen = () => {
  return (
    <SafeAreaView style={[styles.container, Platform.OS === 'ios' ? { overflow: 'scroll' } : undefined]}>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>
         ...
         <Button text='Register' type='link' borderWidth={0} color='primary' style={{width: '100%'}} />
      </View>
    </SafeAreaView>
  );
};
