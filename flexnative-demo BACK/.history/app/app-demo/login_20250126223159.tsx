...
const LoginScreen = () => {
  return (
    <View style={styles.container}>
      ...
      {/* <Block style={styles.form} gap={15}>
      ...
      <View style={styles.form}>
        <TextBox material label='Email 1' placeholder='example@gmail.com'/>
        <TextBox material label='Email 2' placeholder='password' secureTextEntry/>

        <View style={styles.inputGroup}>
        <TextBox material label='Email 3' placeholder='example@gmail.com'/>
        </View>

        <View style={styles.inputGroup}>

      <TextBox label='Email 4' placeholder='example@gmail.com'/>
