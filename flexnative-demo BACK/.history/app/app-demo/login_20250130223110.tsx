...
import { View, Text, TouchableOpacity, StyleSheet, Platform, SafeAreaView, TextInput } from 'react-native';
...
<Formik
    ...
    >
       ...
       <View>
         {/* <FieldTextBox
         /> */}
         <Field name="email" component={FieldTextBox} placeholder="First Name"/>
