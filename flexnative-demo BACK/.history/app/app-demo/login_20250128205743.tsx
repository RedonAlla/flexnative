  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitleText}>to <Text style={styles.brandName}>CRM.io</Text></Text> */}
        ...
        <Block row gap={15}>
            <TextBox label='Active Background Color' placeholder='crimson' material />
            <TextBox label='Active Background Color' placeholder='rgb(237, 20, 61)' material />
          </Block>

      {/* <View style={styles.form}>
        <TextBox label='Active Background Color' placeholder='crimson' activeBackgroundColor='crimson' />
