            ...
            <>
              <KeyboardAvoidingView style={[styles.inputWrapper]} behavior={'position'}>
                ...
                <View style={styles.formField}>
                  <FieldTextBox name="email" label='Email' placeholder='example@domain.com' material backgroundColor={theme.colors.card} />
                </View>

                <View style={styles.formField}>
                  <FieldTextBox name="password" label='Password' placeholder='password' material secureTextEntry backgroundColor={theme.colors.card} />
                  <TouchableOpacity>
