    ...
    return (
      <DemoBlock title='Fill Mode'>
        <Block row flex={1} gap={DEMO_COMPONENT_GAP} wrap='wrap' style={{marginBottom: DEMO_COMPONENT_GAP}}>
          <Avatar source={LOGO_PATH} color='primary' fillMode='solid' />
          <Avatar source={LOGO_PATH} color='primary' fillMode='none' />
          <Avatar source={LOGO_PATH} color='primary' fillMode='ghost' />
        </Block>
