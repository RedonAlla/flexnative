    ...
    return (
      <DemoBlock title='Type'>
        <Block row gap={DEMO_COMPONENT_GAP}>
          <CheckList material label='Label' type="outlined" value={this.state.outlined} onValueChange={this.handleOutlinedChange}>
            <Check value='example1' label='Example 1' />
            <Check value='example2' label='Example 2' />
            <Check value='example3' label='Example 3' />
          </CheckList>

          <CheckList material label='Label' type="underlined" value={this.state.underlined} onValueChange={this.handleUnderlinedChange}>
            <Check value='example1' label='Example 1' />
            <Check value='example2' label='Example 2' />
            <Check value='example3' label='Example 3' />
          </CheckList>
