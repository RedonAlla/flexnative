...
import { HeartbeatIcon as AnimatedIconComponent } from "@flexnative/icons";
...
const meta = {
  ...
  parameters: {
    notes: `
      # Properties
      \`HeartbeatIcon\` inherits all \`AnimatedIcon\` props.

      * pulseColor (string): The color to interpolate to during the beat.
    `,
  },
