...
import { GlitchIcon as AnimatedIconComponent } from "@flexnative/icons";
...
const meta = {
  ...
  parameters: {
    notes: `
      # Properties
      \`GlitchIcon\` inherits all \`AnimatedIcon\` props.

      * amplitude	(number): The intensity of the glitch displacement.
    `,
  },
