 ...
 * @ Modified time: 2024-12-24 18:19:47
 * @ Description: This component demonstrates the usage of the `Check` component with different border colors in checked status.
 */
 ...
 * <CheckedBorderColor />
 */
export default class CheckedBorderColor extends ExampleContainer {
  componentDidMount() {
    this.setState({ items });
  }
  ...
  public render() {
    return (
      <DemoBlock title='Checked Border Color'>
