 ...
 * @ Modified time: 2024-12-24 18:16:30
 * @ Description: This component demonstrates the usage of different background colors in checked status for a CheckBox component.Each `Check` component is assigned a different background color using various color formats (named color, RGB, RGBA, and hex).
 */
 ...
 */
export default class CheckedBackgroundColor extends ExampleContainer {
  componentDidMount() {
    this.setState({ items });
  }
  ...
  public render() {
    return (
      <DemoBlock title='Checked Background Color'>
