    ...
    return (
      <DemoBlock title='Actions'>
        <Block row gap={DEMO_COMPONENT_GAP} style={{marginBottom: DEMO_COMPONENT_GAP * 1.5}}>
          <NumericTextBox material label={'With actions'} placeholder='With actions' />
          <NumericTextBox material label={'Without actions'} placeholder='Without actions' actions={false} />
        </Block>
