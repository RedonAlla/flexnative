...
export default class extends React.Component<{}, StateType> {
  ...
  public handleTextValues(selectedItem: string | Array<string>) {
    this.setState({textValues: selectedItem as Array<string>});
  }

  public handleCustomValues(selectedItems: string | Array<string>) {
    this.setState({customValues: selectedItems as Array<string>});
  }
