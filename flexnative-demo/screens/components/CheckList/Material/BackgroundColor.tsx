      ...
      <DemoBlock title='Background Color'>
        <Block row gap={DEMO_COMPONENT_GAP}>
          ...
          <Block flex={1} gap={DEMO_COMPONENT_GAP}>
            <CheckList material label='Label' backgroundColor="crimson" value={this.state.nameValues} onValueChange={this.handleNameValueChange}>
              <Check value='crimson' label='crimson' />
              <Check value='blue' label='blue' />
              <Check value='red' label='red' />
            </CheckList>

            <CheckList material label='Label' backgroundColor="rgb(237, 20, 61)" value={this.state.rgbValues} onValueChange={this.handleRgbValueChange}>
          ...
          <Block flex={1} gap={DEMO_COMPONENT_GAP}>
            <CheckList material label='Label' backgroundColor="#ed143d" value={this.state.hexValues} onValueChange={this.handleHexValueChange}>
              <Check value='#ed143d' label='#ed143d' />
              <Check value='#ce04d1' label='#ce04d1' />
              <Check value='#343deb' label='#343deb' />
            </CheckList>

            <CheckList material label='Label' backgroundColor="rgba(237, 20, 61, 0.5)" value={this.state.rgbaValues} onValueChange={this.handleRgbaValueChange}>
